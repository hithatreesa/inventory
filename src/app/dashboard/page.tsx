         ...
         <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-white p-8 rounded-3xl border border-border-main shadow-sm gap-6">
            ...
            <div className="flex w-full sm:w-auto gap-4">
               <button
                  ...
                  className="flex-1 sm:flex-none h-12 px-8 rounded-xl bg-[#003366] text-white font-black text-[10px] tracking-widest uppercase italic shadow-lg shadow-primary/20 flex items-center justify-center gap-2"
               >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-12">
               ...
               <div className="lg:col-span-2 bg-[#003366] rounded-[40px] p-10 text-white shadow-2xl shadow-primary/20 relative overflow-hidden group">
                  <div className="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full blur-3xl -mr-32 -mt-32 group-hover:bg-white/10 transition-all duration-1000"></div>
                  <div className="relative z-10 flex flex-col h-full justify-between">
                     ...
                     <div className="flex items-center justify-between border-t border-white/10 pt-8 mt-12">
                        <div className="flex -space-x-4">
                           {[1, 2, 3, 4].map(i => (
                              <div key={i} className="w-10 h-10 rounded-full border-2 border-[#003366] bg-gray-200 overflow-hidden shadow-xl"></div>
                           ))}
