...
function DetailedReportContent() {
   ...
   return (
      <div className="space-y-8 pb-24 animate-in fade-in duration-500 text-text-main">
         ...
         <div className="space-y-4">
            ...
            <div className="flex flex-col lg:flex-row justify-between lg:items-center bg-white p-8 rounded-[32px] border border-border-main shadow-sm gap-6">
               ...
               <div className="flex flex-wrap gap-2">
                  <Button variant="secondary" onClick={() => handleExport('pdf')} className="h-10 sm:h-12 px-4 sm:px-6 rounded-xl font-black text-[9px] sm:text-[10px] tracking-widest uppercase italic bg-white border-gray-100 flex items-center gap-2 group">
                     <FileText className="w-4 h-4 text-red-500 group-hover:scale-110 transition-transform" /> PDF
                  </Button>
                  <Button variant="secondary" onClick={() => handleExport('csv')} className="h-10 sm:h-12 px-4 sm:px-6 rounded-xl font-black text-[9px] sm:text-[10px] tracking-widest uppercase italic bg-white border-gray-100 flex items-center gap-2 group">
                     <Download className="w-4 h-4 text-green-500 group-hover:scale-110 transition-transform" /> CSV
                  </Button>
                  <Button variant="secondary" className="h-10 sm:h-12 px-4 sm:px-6 rounded-xl font-black text-[9px] sm:text-[10px] tracking-widest uppercase italic bg-white border-gray-100 flex items-center gap-2 group">
         ...
         {/* FILTER SECTION */}
         <div className="bg-white p-6 rounded-[32px] border border-border-main shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full sm:w-auto">
               ...
               <div className="flex gap-2 w-full sm:w-auto">
                  <select className="flex-1 sm:flex-none bg-gray-50 border border-gray-100 rounded-lg text-[10px] font-black px-4 py-2 italic focus:outline-none appearance-none cursor-pointer hover:bg-gray-100 transition-colors">
            ...
            <Button variant="secondary" className="w-full md:w-auto h-10 px-6 rounded-xl font-black text-[9px] uppercase italic tracking-widest border-gray-100">
               Apply Filters
            </Button>
         </div>
         ...
         <div className="bg-white rounded-[40px] border border-border-main p-4 sm:p-8 shadow-sm space-y-8 overflow-hidden">
            ...
            <div className="overflow-x-auto min-h-[400px]">
               <table className="w-full text-left font-bold min-w-[800px] lg:min-w-0">
                  <thead>
