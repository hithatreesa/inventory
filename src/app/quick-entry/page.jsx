        ...
        <div className="space-y-8 pb-12">
            ...
            <div className="space-y-4">
                <div className="flex justify-between items-center px-6">
                    <h3 className="text-xl font-black text-text-main italic tracking-tight uppercase leading-none">Global Transaction Ledger</h3>
                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] font-black text-text-secondary uppercase tracking-widest opacity-60">
                                            {item.product} • <span className="text-primary italic font-black">₹{item.amount}</span>
                                        </p>
                                    </div>
                                </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                            <div className="grid grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label className="text-[9px] font-black text-text-secondary uppercase tracking-widest opacity-60 pl-4">Customer Name</label>
                                ...
                                <div className="space-y-2">
                                    <label className="text-[9px] font-black text-text-secondary uppercase tracking-widest opacity-60 pl-4">Product / Identifier</label>
                                    <div className="relative group">
                            ...
                            <div className="space-y-2">
                                <label className="text-[9px] font-black text-text-secondary uppercase tracking-widest opacity-60 pl-4">Transaction Amount (₹)</label>
                                <div className="relative group">
                            ...
                            <div className="flex gap-4 pt-4">
                                ...
                                >
                                    <Save className="w-5 h-5 mr-1" /> COMMIT ENTRY
                                </Button>
                            </div>
                        </form>
                    </div>
