    ...
    <div className="space-y-6 pb-24 animate-in fade-in duration-500 text-text-main">
      ...
      <div className="flex justify-between items-center bg-white p-8 rounded-3xl border border-border-main shadow-sm">
        <div>
           ...
           <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest pl-1 italic">Enterprise Operational Control Engine</p>
        </div>
        <div className="flex gap-4">
           <Button variant="secondary" className="h-12 px-6 rounded-xl font-black text-[10px] tracking-widest uppercase italic bg-white border-gray-100 hover:bg-gray-50 flex items-center gap-2">
              <Plus className="w-4 h-4 text-primary" /> Import
           </Button>
           <Button variant="secondary" className="h-12 px-6 rounded-xl font-black text-[10px] tracking-widest uppercase italic bg-white border-gray-100 hover:bg-gray-50 flex items-center gap-2">
              <Download className="w-4 h-4 text-primary" /> Export
           </Button>
           <Button className="h-12 px-8 rounded-xl font-black text-[10px] tracking-widest uppercase italic shadow-lg shadow-primary/20 flex items-center gap-2">
